    ...
    function ThirdPartyAuth() {
        ...
        _this.render = function () {
            return React.createElement(
                ...
                {
                    redirectToLogin: _this.redirectToLogin,
        ...
        _this.getRecipeInstanceOrThrow = function () {
            ...
            throw new Error(
                recipe.recipeId + " must be an instance of AuthRecipeModule to use ThirdPartyAuth component."
            );
        };
...
function ThirdPartyAuthWrapper(_a) {
    ...
    if (reactRouterDom === undefined) {
        return React.createElement(ThirdPartyAuth, { requireAuth: requireAuth, recipeId: recipeId }, children);
    }
    var Component = reactRouterDom.withRouter(ThirdPartyAuth);
    return React.createElement(Component, { requireAuth: requireAuth, recipeId: recipeId }, children);
}
