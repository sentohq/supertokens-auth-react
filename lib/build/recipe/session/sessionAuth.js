...
var SessionAuth = /** @class */ (function (_super) {
    ...
    function SessionAuth(props) {
        ...
        _this.handleSessionAuthContextFromParent = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.props.redirectToLogin()];
                        case 1:
                        ...
                        case 2:
                            this.setState(function (oldState) {
                                ...
                                return __assign({}, oldState, { status: "IS_IN_NESTED_SESSION_AUTH" });
                            });
                            return [2 /*return*/];
                    }
                });
        ...
        _this.subscribeToSessionStateChangesAndCreateContext = function () {
            return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.render = function () {
            ...
            } else if (_this.state.status === "IS_IN_NESTED_SESSION_AUTH") {
                return react_1.default.createElement(react_1.default.Fragment, null, _this.props.children);
            }
            return null;
        };
        _this.state = {
    ...
    SessionAuth.prototype.componentDidUpdate = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!sessionContext_1.isDefaultSessionContext(this.context)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.handleSessionAuthContextFromParent()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2:
                        return [4 /*yield*/, this.subscribeToSessionStateChangesAndCreateContext()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    SessionAuth.contextType = sessionContext_1.default;
    return SessionAuth;
