    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (value.match(defaultEmailValidatorRegexp) === null) {
                return [2 /*return*/, "Email ist nicht valide"];
            }
...
function defaultPasswordValidator(value) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            // as per https://github.com/supertokens/supertokens-auth-react/issues/5#issuecomment-709512438
            if (value.length < 8) {
                return [2 /*return*/, "Das Passwort muss mindestens 8 Zeichen lang sein und eine Zahl enthalten"];
            }
            if (value.length >= 100) {
                return [2 /*return*/, "Das Passwort darf nicht länger als 100 Zeichen sein"];
            }
            if (value.match(/^.*[A-Za-z]+.*$/) === null) {
                return [2 /*return*/, "Das Passwort muss mindestens einen Buchstaben enthalten"];
            }
            if (value.match(/^.*[0-9]+.*$/) === null) {
                return [2 /*return*/, "Das Passwort muss mindestens eine Zahl enthalten"];
            }
            return [2 /*return*/, undefined];
        });
    });
